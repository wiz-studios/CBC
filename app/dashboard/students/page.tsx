...
export const metadata = {
  title: 'Students - CBC Academic System',
}
      ...
      <section className="rounded-3xl border border-border/60 bg-card/80 p-6 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-4xl font-display font-semibold">Students</h1>
            <p className="mt-2 text-muted-foreground">Add, place, and update students by class and term.</p>
          </div>
        </div>
      </section>

      <StudentsManager canManage={user.role === 'SCHOOL_ADMIN'} />
    </div>
  )
}
